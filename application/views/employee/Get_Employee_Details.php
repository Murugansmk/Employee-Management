...
?>
            ...
            <div class="form-group">
             ...
             <div class="form-group">
              <div class="form-label-group">
              	<?php echo form_input(['type'=>'file','name'=>'DegreeCertificate','multiple'=>'','id'=>'DegreeCertificate','class'=>'form-control','value'=>$EmployeeDetails->Designation]);?>
				<?php echo form_label('Uoload your Degree Certificate', 'DegreeCertificate'); ?>
				<?php
				if(!empty($EmployeeDetails->DegreeCertificatePath))
				{?>
					<iframe src="<?php echo site_url().$EmployeeDetails->DegreeCertificatePath; ?>" title="description"></iframe>
				<?php
				}
				?>
             ...
             <div class="form-group">
              <div class="form-label-group">
				...
				<?php
				if(!empty($EmployeeDetails->PassportCopyPath))
				{?>
					<iframe src="<?php echo site_url().$EmployeeDetails->PassportCopyPath; ?>" title="description"></iframe>
				<?php
				}
				?>
              </div>
             ...
             <div class="form-group">
              <div class="form-label-group">
				...
				<?php
				if(!empty($EmployeeDetails->ResumePath))
				{?>
					<iframe src="<?php echo site_url().$EmployeeDetails->ResumePath; ?>" title="description"></iframe>
				<?php
				}
				?>
              </div>
			...
			<?php } ?> 
 			...
 			<?php echo form_submit(['name'=>'Submit','value'=>'Update','class'=>'btn btn-primary btn-block']); ?>
